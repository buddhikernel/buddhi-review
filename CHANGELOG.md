...
* **round-driver:** the merge boundary follows the pushed commit, not the label, and a pushing round re-offers its head only when nobody else covers it ([#109](https://github.com/buddhikernel/buddhi-review/issues/109)) ([6a87776](https://github.com/buddhikernel/buddhi-review/commit/6a877763127b75953bc7914a88bb73b91d2d51b4))
